# 📂 Raw Datasets
This directory serves as the foundation for your project, containing the original, unprocessed source files used for training and evaluation.

## 🎯 Purpose
* Source of Truth: Houses the initial data files (e.g., .csv, .json).
